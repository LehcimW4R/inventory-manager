...
func (_m *MockRepository) GetProduct(ctx context.Context, id int64) (*models.Product, error) {
...
func (_m *MockRepository) GetProducts(ctx context.Context) ([]models.Product, error) {
	ret := _m.Called(ctx)
...
func (_m *MockRepository) GetUserByEmail(ctx context.Context, email string) (*models.User, error) {
...
func (_m *MockRepository) GetUserRoles(ctx context.Context, userID int64) ([]models.UserRole, error) {
	ret := _m.Called(ctx, userID)

	var r0 []models.UserRole
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64) ([]models.UserRole, error)); ok {
		return rf(ctx, userID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int64) []models.UserRole); ok {
		r0 = rf(ctx, userID)
	} else {
		if ret.Get(0) != nil {
